 ...
 */
public enum FASSETS_other implements IBWInterface {


    DO_YOU_HAVE_ANY_ASSETS("Do You have any assets like shares, or land?", "Yes"),
    WHAT_IS_TYPE_OF_ASSET("What is type of asset?", "Other"),
    NATURE_OF_OTHER_FINANCIAL_ASSET("Nature of other financial asset", null),
    CURRENT_VALUE("Current value", null);

    public static final Log log = LogFactory.getLog(FASSETS_other.class);
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("FASSETS_other executing method getExpectedFieldNames");
        ...
        expectedFieldNames.set(2, NATURE_OF_OTHER_FINANCIAL_ASSET.getFieldName());
        expectedFieldNames.set(3, CURRENT_VALUE.getFieldName());
    ...
    public static Map<String, String> getTriggerMap() {
        log.debug("FASSETS_other executing method getTriggerMap");
    ...
    public static ArrayList<String> getTriggerFields() {
        log.debug("FASSETS_other executing method getTriggerFields");
