...
/**
 * Created by viliamstrobich on 27/10/15 - 09:32.
 */
public enum EMPANDINCOME_paye implements IBWInterface{
    ...
    public static final Log log = LogFactory.getLog(EMPANDINCOME_paye.class);
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("EMPANDINCOME_paye executing method getExpectedFieldNames");
