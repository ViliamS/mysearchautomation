 ...
 */
public enum YFUNDING_gift implements IBWInterface {

    WHAT_IS_SOURCE_OF_FUNDS("WHAT IS THE SOURCE OF FUNDS?", "Gift"),
    DESCRIPTION("Description", null),
    AMOUNT("Amount", null);

    public static final Log log = LogFactory.getLog(YFUNDING_gift.class);
    ...
    public static ArrayList<String> getExpectedFieldNames(){
        log.debug("YFUNDING_gift executing method getExpectedFieldNames");
