...
/**
 * Created by viliamstrobich on 25/10/15 - 11:43.
 */
public enum PERSONAL_DETAILS_coapplicant implements IBWInterface {
    ...
    public static final Log log = LogFactory.getLog(PERSONAL_DETAILS_coapplicant.class);

    private String getFieldName;
    private String getFieldNameValue;


    PERSONAL_DETAILS_coapplicant(String getFieldName, String getFieldNameValue) {
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("PERSONAL_DETAILS_coapplicant executing method getExpectedFieldNames");
    ...
    public static Map<String, String> getTriggerMap() {
        log.debug("PERSONAL_DETAILS_coapplicant executing method getTriggerMap");
    ...
    public static ArrayList<String> getTriggerFields() {
        log.debug("PERSONAL_DETAILS_coapplicant executing method getTriggerFields");
