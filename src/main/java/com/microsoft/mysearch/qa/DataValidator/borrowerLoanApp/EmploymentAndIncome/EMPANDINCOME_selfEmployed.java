...
/**
 * Created by viliamstrobich on 29/10/15 - 11:24.
 */
public enum EMPANDINCOME_selfEmployed implements IBWInterface{

    CATEGORY("Category", "Self Employed"),
    ...
    public static final Log log = LogFactory.getLog(EMPANDINCOME_selfEmployed.class);
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("EMPANDINCOME_selfEmployed executing method getExpectedFieldNames");
