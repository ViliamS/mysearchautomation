...
/**
 * Created by viliamstrobich on 27/10/15 - 14:21.
 */
public enum YACCOUNTS_savingsAccount implements IBWInterface {

    WHAT_IS_THE_SOURCE_OF_FUNDS("What is the source of funds?", "Savings Account"),
    ...
    SOURCE_OF_SAVINGS("Source of savings", null),
    OVERDRAFT_LIMIT("Overdraft limit", null);

    public static final Log log = LogFactory.getLog(YACCOUNTS_savingsAccount.class);

    private String getFieldName;
    private String getFieldNameValue;

    YACCOUNTS_savingsAccount(String getFieldName, String getFieldNameValue){
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("YACCOUNTS_savingsAccount executing method getExpectedFieldNames");
        ...
        expectedFieldNames.set(4, SOURCE_OF_SAVINGS.getFieldName());
        expectedFieldNames.set(5, OVERDRAFT_LIMIT.getFieldName());
