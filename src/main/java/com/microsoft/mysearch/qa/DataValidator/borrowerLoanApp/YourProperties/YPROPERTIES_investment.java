...
/**
 * Created by viliamstrobich on 27/10/15 - 14:34.
 */
public enum YPROPERTIES_investment implements IBWInterface {

    DO_YOU_HAVE_STAKE_IN_PROPERTY("Do either of you have a stake in any property?", "Yes"),
    PROPERTY_CATEGORY("Property Category", "Investment"),
    MONTHLY_RENT("Monthly rent", null),
    RENT_IS("Rent is", null),
    ...
    public static final Log log = LogFactory.getLog(YPROPERTIES_investment.class);

    private String getFieldName;
    private String getFieldNameValue;

    YPROPERTIES_investment(String getFieldName, String getFieldNameValue){
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("YPROPERTIES_investment executing method getExpectedFieldNames");
        ...
        expectedFieldNames.set(2, MONTHLY_RENT.getFieldName());
        expectedFieldNames.set(3, RENT_IS.getFieldName());
        expectedFieldNames.set(4, ADDRESS_LINE1.getFieldName());
        expectedFieldNames.set(5, ADDRESS_LINE2.getFieldName());
        expectedFieldNames.set(6, TOWN_CITY.getFieldName());
        expectedFieldNames.set(7, POST_CODE.getFieldName());
        expectedFieldNames.set(8, PROPERTY_TYPE.getFieldName());
        expectedFieldNames.set(9, NUMBER_OF_BEDROOMS.getFieldName());
        expectedFieldNames.set(10, YEAR_PROPERTY_WAS_ACQUIRED.getFieldName());
        expectedFieldNames.set(11, ORIGINAL_PURCHASE_PRICE.getFieldName());
        expectedFieldNames.set(12, IS_THIS_PROPERTY_MORTGAGED.getFieldName());
        expectedFieldNames.set(13, DO_YOU_PLAN_TO_SELL_IT.getFieldName());
        expectedFieldNames.set(14, ESTIMATED_VALUE_SALE_AGREED_PRICE.getFieldName());
    ...
    public static ArrayList<String> getExpectedFieldNames(ArrayList<Boolean> addAnotherMortgage){
        log.debug("YPROPERTIES_investment executing method getExpectedFieldNames(ArrayList<Boolean> addAnotherMortgage = '" + addAnotherMortgage + "')");
    ...
    public static ArrayList<String> getExpectedFieldNames(String isThisPropertyMortgagedValue, @Nullable boolean addAnotherMortgage){
        log.debug("YPROPERTIES_investment executing method getExpectedFieldNames(String isThisPropertyMortgagedValue = '" + isThisPropertyMortgagedValue + "', @Nullable boolean addAnotherMortgage = '" + addAnotherMortgage + "')");
    ...
    public static String getTriggerField(int position){
        log.debug("YPROPERTIES_investment executing method getTriggerField");
        switch (position) {
            case 0:
    ...
    public static String getTriggerFieldValue(int position){
        log.debug("YPROPERTIES_investment executing method getTriggerFieldValue");
        switch (position) {
            case 0:
    ...
    public static Map<String, String> getTriggerMap() {
        log.debug("YPROPERTIES_investment executing method getTriggerMap");
    ...
    public static ArrayList<String> getTriggerFields() {
        log.debug("YPROPERTIES_investment executing method getTriggerFields");
        ...
        triggerArrayList.set(2, IS_THIS_PROPERTY_MORTGAGED.getFieldName());
        triggerArrayList.set(3, ADD_ANOTHER_MORTGAGE_ACCOUNT.getFieldName());
