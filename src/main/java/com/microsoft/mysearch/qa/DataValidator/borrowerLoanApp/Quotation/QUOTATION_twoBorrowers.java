...
/**
 * Created by viliamstrobich on 22/10/15 - 16:19.
 */
public enum QUOTATION_twoBorrowers implements IBWInterface {

    NUMBER_OF_BORROWERS ("Number of Borrowers", "I want a quote for", "two borrowers"), //If second value is present then this value is responsible for triggering this Collection of expected data
    ...
    QUOTATION_twoBorrowers(String getFieldName, String getTextNextToField, String getFieldNameValue) {
    ...
    public static ArrayList<String> getExpectedFieldNames(){
        ...
        expectedFieldNames.set(3, BORROWERS_MARITAL_STATUS.getFieldName());
        expectedFieldNames.set(4, NUMBER_OF_DEPENDANTS.getFieldName());
        expectedFieldNames.set(5, INCOME_TYPE_FIRST_BORROWER.getFieldName());
        expectedFieldNames.set(6, INCOME_AMOUNT_FIRST_BORROWER.getFieldName());

        expectedFieldNames.set(7, OTHER_FINANCIAL_COMMITMENTS.getFieldName());
