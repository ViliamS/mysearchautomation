...
/**
 * Created by viliamstrobich on 29/10/15 - 11:26.
 */
public enum EMPANDINCOME_unemployedHomemaker implements IBWInterface {

    CATEGORY("Category", "Unemployed Homemaker"),
    ...
    public static final Log log = LogFactory.getLog(EMPANDINCOME_unemployedHomemaker.class);
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("EMPANDINCOME_unemployedHomemaker executing method getExpectedFieldNames");
