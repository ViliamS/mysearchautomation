 ...
 */
public enum FCOMMITMENTS_carLoan implements IBWInterface{

    PLEASE_OUTLINE_ANY_SHORT_TERM_DEBT("Please outline any short-term debt…", "Yes"),
    WHAT_IS_TYPE_OF_FINANCIAL_COMMITMENT("What is type of financial commitment?", "Car Loan"),
    ...
    public static final Log log = LogFactory.getLog(FCOMMITMENTS_carLoan.class);

    private String getFieldName;
    private String getFieldNameValue;

    FCOMMITMENTS_carLoan(String getFieldName, String getFieldNameValue) {
    ...
    public static ArrayList<String> getExpectedFieldNames(){
        log.debug("FCOMMITMENTS_carLoan executing method getExpectedFieldNames");
    ...
    public static Map<String, String> getTriggerMap(){
        log.debug("FCOMMITMENTS_carLoan executing method getTriggerMap");
    ...
    public static ArrayList<String> getTriggerFields(){
        log.debug("FCOMMITMENTS_carLoan executing method getTriggerFields");
