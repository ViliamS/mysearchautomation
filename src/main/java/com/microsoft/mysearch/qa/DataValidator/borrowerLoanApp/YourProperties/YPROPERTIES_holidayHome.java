 ...
 */
public enum YPROPERTIES_holidayHome implements IBWInterface{

    DO_YOU_HAVE_STAKE_IN_PROPERTY("Do either of you have a stake in any property?", "Yes"),
    PROPERTY_CATEGORY("Property Category", "Holiday Home"),
    ...
    public static final Log log = LogFactory.getLog(YPROPERTIES_holidayHome.class);
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("YPROPERTIES_holidayHome executing method getExpectedFieldNames");
    ...
    public static ArrayList<String> getExpectedFieldNames(ArrayList<Boolean> addAnotherMortgage){
        log.debug("YPROPERTIES_holidayHome executing method getExpectedFieldNames(ArrayList<Boolean> addAnotherMortgage = '" + addAnotherMortgage + "')");
    ...
    public static ArrayList<String> getExpectedFieldNames(String isThisPropertyMortgagedValue, @Nullable boolean addAnotherMortgage){
        log.debug("YPROPERTIES_holidayHome executing method getExpectedFieldNames(String isThisPropertyMortgagedValue = '" + isThisPropertyMortgagedValue + "', @Nullable boolean addAnotherMortgage = '" + addAnotherMortgage + "')");
    ...
    public static String getTriggerField(int position){
        log.debug("YPROPERTIES_holidayHome executing method getTriggerField");
        switch (position) {
            case 0:
    ...
    public static String getTriggerFieldValue(int position){
        log.debug("YPROPERTIES_holidayHome executing method getTriggerFieldValue");
        switch (position) {
            case 0:
    ...
    public static Map<String, String> getTriggerMap() {
        log.debug("YPROPERTIES_holidayHome executing method getTriggerMap");
    ...
    public static ArrayList<String> getTriggerFields() {
        log.debug("YPROPERTIES_holidayHome executing method getTriggerFields");
