...
/**
 * Created by viliamstrobich on 29/10/15 - 11:19.
 */
public enum FCOMMITMENTS_studentLoan implements IBWInterface {

    PLEASE_OUTLINE_ANY_SHORT_TERM_DEBT("Please outline any short-term debt…", "Yes"),
    WHAT_IS_TYPE_OF_FINANCIAL_COMMITMENT("What is type of financial commitment?", "Student Loan"),
    ...
    public static final Log log = LogFactory.getLog(FCOMMITMENTS_studentLoan.class);
    ...
    public static ArrayList<String> getExpectedFieldNames(){
        log.debug("FCOMMITMENTS_studentLoan executing method getExpectedFieldNames");
        ...
        expectedFieldNames.set(5, FINAL_REPAYMENT_DATE.getFieldName());
        expectedFieldNames.set(6, REPAYMENT_AMOUNT.getFieldName());
    ...
    public static Map<String, String> getTriggerMap(){
        log.debug("FCOMMITMENTS_studentLoan executing method getTriggerMap");
    ...
    public static ArrayList<String> getTriggerFields(){
        log.debug("FCOMMITMENTS_studentLoan executing method getTriggerFields");
