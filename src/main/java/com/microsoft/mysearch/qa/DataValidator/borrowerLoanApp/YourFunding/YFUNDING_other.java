...
/**
 * Created by viliamstrobich on 29/10/15 - 11:21.
 */
public enum YFUNDING_other implements IBWInterface {

    WHAT_IS_SOURCE_OF_FUNDS("WHAT IS THE SOURCE OF FUNDS?", "Other"),
    DESCRIPTION("Description", null),
    AMOUNT("Amount", null);

    public static final Log log = LogFactory.getLog(YFUNDING_other.class);

    private String getFieldName;
    private String getFieldNameValue;

    YFUNDING_other(String getFieldName, String getFieldNameValue) {
    ...
    public static ArrayList<String> getExpectedFieldNames(){
        log.debug("YFUNDING_other executing method getExpectedFieldNames");
