 ...
 */
public enum EMPANDINCOME_civilServant implements IBWInterface {

    CATEGORY("Category", "Civil Servant"),
    ...
    public static final Log log = LogFactory.getLog(EMPANDINCOME_civilServant.class);
    ...
    public static ArrayList<String> getExpectedFieldNames() {
        log.debug("EMPANDINCOME_civilServant executing method getExpectedFieldNames");
